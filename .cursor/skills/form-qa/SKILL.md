...
1. Read `docs/ops/QA-CHECKLIST.md` and `apps/dashboard/FORM_GATE_QA.md`.
...
7. If GHL fails intentionally, confirm Missed Leads tab + alert path per `docs/ops/LEAD-RECOVERY.md`.
